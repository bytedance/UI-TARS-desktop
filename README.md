...
> 🎁 The `atlascloud` provider lets you point TARS at [Atlas Cloud](https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=UI-TARS-desktop) — a full-modal, OpenAI-compatible inference platform serving DeepSeek, Qwen, GLM, Kimi, MiniMax and more through a single API. Configure it like any other OpenAI-compatible backend (`baseURL: https://api.atlascloud.ai/v1`, model e.g. `deepseek-ai/deepseek-v4-pro`). See the [coding plan](https://www.atlascloud.ai/console/coding-plan) for pricing.
>
> <details>
