...
const TABLE_STYLES = {
  ...
  table: 'min-w-full border-collapse border border-gray-300 dark:border-gray-600 text-sm',
  thead: 'bg-gray-100 dark:bg-gray-800',
  tbody: 'divide-y divide-gray-200 dark:divide-gray-700',
  tr: 'hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors',
  th: 'px-4 py-3 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider border-b border-gray-300 dark:border-gray-600',
  td: 'px-4 py-3 text-gray-800 dark:text-gray-200 border-gray-200 dark:border-gray-700',
};
