...
The Web UI Configuration API allows you to customize the Agent web interface appearance, layout, and behavior. Configure branding, welcome screens, navigation, and GUI Agent display options.
...
Set Web UI configuration through the static `webuiConfig` property:
