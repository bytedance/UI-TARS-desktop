...
在三月份，我们开源了 Agent TARS 的早期[技术预览版](https://agent-tars.com/2025/03/18/announcing-agent-tars-app)。Agent TARS 的口号是<u>"一个开源的多模态 AI Agent，提供与各种现实世界工具的无缝集成"</u>。在发布后，它获得了社区的一些支持并积累了一定的影响力。
