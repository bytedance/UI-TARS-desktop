...
在三月份，我们开源了 Agent TARS 的早期 [Technical Preview](https://agent-tars.com/2025/03/18/announcing-agent-tars-app)。Agent TARS 的 Slogan 是<u>"一个开源的多模态 AI Agent，提供与各种现实世界工具的无缝集成的能力"</u>。在发布后，我们获得了社区的一些支持并积累了一定的影响力。
...
本次发布是一个开始，事实上，我们仅仅发布了 Agent TARS 的默认版本，一个带有动态规划推理的版本正在内测中，敬请期待。

Agent TARS 仍在飞速的发展之中，虽然本次发布，我们带来了很多新能力，但仍有很多部分需要完善，如开发者文档、对交付物的呈现等等，我们期望能够让社区尽快看到

我们还有前沿的能力仍在内测之中，未来，我们期望 Agent TARS 能够真正地成为大家随时随地可用的 Agent 开发者工具。请期待我们的更新，感谢所有支持过我们的社区同学 ❤️
