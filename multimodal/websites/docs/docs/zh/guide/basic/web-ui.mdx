...
在 Agent TARS 中，官方默认提供了一个功能完备的 Web UI，支持会话管理、呈现 MCP Tool Result，拥有 [Native Streaming](#native-streaming)、[GUI Graounding Transition](#gui-graounding-transition)、[Share 与 Reply](#share-and-reply) 等能力：
