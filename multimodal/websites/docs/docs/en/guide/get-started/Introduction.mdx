...
Agent TARS is an open source multimodal AI agent that aims to explore a work form that is closer to human-like task completion through rich multimodal capabilities (such as [GUI Agent](../basic/browser-operation.mdx#visual-grounding), [Vision](../basic/vision.md)) and seamless integration with various real-world tools. It has built-in commonly used tools ([Search](../basic//search.md), [Browser](../basic/browser-operation.md), [File](../basic/file.md), [Command](../basic/command.md) etc.).
