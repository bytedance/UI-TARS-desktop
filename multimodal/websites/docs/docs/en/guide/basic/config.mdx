...
::: warning
Agent TARS configuration options may change with version updates. When upgrading Agent TARS versions, please refer to the documentation for the corresponding version to understand potential configuration changes.
:::
