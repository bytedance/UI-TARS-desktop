...
In Agent TARS, we provide a feature-complete Web UI by default, supporting session management, MCP Tool Result presentation, with capabilities like [Native Streaming](#native-streaming), [GUI Grounding Transition](#gui-graounding-transition), [Share and Reply](#share-and-reply), and more:
