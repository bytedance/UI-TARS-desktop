...
在 Agent TARS 中，官方默认提供了一个功能完备的 Web UI，支持会话管理、呈现 MCP Tool Result，拥有 Native Streaming、GUI Graounding Cursor Transition、Share、Reply 等能力：
...
### GUI Graounding Cursor Transition
