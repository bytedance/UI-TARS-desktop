...
In March, we open-sourced an early preview version of Agent TARS. The slogan of Agent TARS is “An open-source multimodal AI agent, offering seamless integration with a wide range of real-world tools”. After our release, it received some support from the community and accumulated a certain amount of influence:
