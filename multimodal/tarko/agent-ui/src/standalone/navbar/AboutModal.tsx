                    ...
                    {sessionMetadata.modelConfig.id && (
                      <div className="flex items-center gap-2 min-w-0">
                        <span
                          ...
                          title={sessionMetadata.modelConfig.displayName || sessionMetadata.modelConfig.id}
                          onClick={() =>
                            copyModelId(sessionMetadata.modelConfig.displayName || sessionMetadata.modelConfig.id)
                          }
                        >
                          {truncateModel(sessionMetadata.modelConfig.displayName || sessionMetadata.modelConfig.id)}
                        </span>
                        <motion.button
                          whileHover={{ scale: 1.1 }}
                          whileTap={{ scale: 0.9 }}
