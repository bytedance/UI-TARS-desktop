              ...
              {displayedPrompts.map((prompt, index) => {
                ...
                const buttonElement = (
                  <motion.button
                    ...
                    className="text-sm px-4 py-2 rounded-full bg-white dark:bg-gray-800 border border-gray-200/50 dark:border-gray-700/30 hover:bg-gray-50 dark:hover:bg-gray-700/50 text-gray-600 dark:text-gray-300 transition-colors max-w-xs whitespace-nowrap"
                    disabled={isLoading || isDirectChatLoading}
                  >
                    {truncatedPrompt}
                  </motion.button>
