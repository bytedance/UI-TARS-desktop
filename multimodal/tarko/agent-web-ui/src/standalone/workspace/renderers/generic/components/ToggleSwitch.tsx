        ...
        <button
          ...
          className={`px-3 py-1.5 text-xs font-medium transition-all duration-200 backdrop-blur-sm ${
            value === leftValue
              ...
              : 'bg-slate-50/80 dark:bg-slate-800/30 text-slate-600 dark:text-slate-300 hover:bg-slate-100/90 dark:hover:bg-slate-700/80 hover:text-slate-700 dark:hover:text-slate-200 hover:shadow-sm'
