...
export async function createSession(req: Request, res: Response) {
  try {
    ...
    // Note: Runtime settings are now included in savedSessionInfo during session creation,
    // so no need to call updateSessionConfig which would recreate the agent and duplicate events
